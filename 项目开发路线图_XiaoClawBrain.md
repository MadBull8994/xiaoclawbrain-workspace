...
创建时间：2026-05-20
用途：保留 P0-P9 第一阶段的原始执行顺序、任务拆分和验收口径。第二阶段请转到 `第二阶段开发路线图_XiaoClawBrain.md`。
最近对齐：2026-06-04
...
- P6 旧架构清理保持收口，P9 本地语音唤醒已于 2026-06-02 完成 10/10 实机复测通过。
- 2026-06-04 复核未发现需要重新打开第一阶段验收结论的新增功能性阻塞。
- 本文件从现在起主要作为第一阶段历史路线与验收口径参考，不再承担第二阶段开工入口。
...
第二阶段正式入口见 [第二阶段开发路线图_XiaoClawBrain.md](./第二阶段开发路线图_XiaoClawBrain.md)。
...
1. 如果要回看第一阶段为什么这么拆、每一阶段的任务和验收是什么，继续参考本文件。
2. 如果要判断当前项目从哪里继续，优先看 [第二阶段开发路线图_XiaoClawBrain.md](./第二阶段开发路线图_XiaoClawBrain.md)。
3. 如果后续发现问题会直接推翻 P0-P9 已完成的结论，再回到本文件对应阶段重新开口径；否则不要再把第二阶段工作混写成第一阶段尾巴。
